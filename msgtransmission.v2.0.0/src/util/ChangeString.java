...
public class ChangeString
{
    ...
    {
        boolean[] output = this.Binstr16ToBool(this.BinstrToBinstr16(this.StrToBinstr(input)));
        return output;
    }
    ...
    {
        String output = this.BinstrToStr(this.Binstr16ToBinstr(this.BoolToBinstr16(input)));
        return output;
    }
    ...
    {
        String[] tempStr = this.StrToStrArray(binStr);
    ...
    private String BinstrToBinstr16(String input)
    {
        ...
        String[] tempStr = this.StrToStrArray(input);
        for (int i = 0; i < tempStr.length; i++)
        {
